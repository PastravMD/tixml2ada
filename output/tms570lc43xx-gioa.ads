--  This spec has been automatically generated from hercules_gio_port_a_spec_1.2.1.xml
...
package TMS570LC43xx.GioA is
   ...
   type GioA_Peripheral is record
      --  Data Direction Gio A
      Dir  : Dir_Register;
      --  Data Input Gio A
      DIn  : DIn_Register;
      ...
      --  Pull Select Gio A
      PSel : PSel_Register;
      --  Slew Rate Select Gio A
      Srs  : TMS570LC43xx.Word;
   end record
     with Volatile;

   for GioA_Peripheral use record
      Dir  at 16#34# range 0 .. 31;
      DIn  at 16#38# range 0 .. 31;
      DOut at 16#3C# range 0 .. 31;
      DSet at 16#40# range 0 .. 31;
      DClr at 16#44# range 0 .. 31;
      PDr  at 16#48# range 0 .. 31;
      PDis at 16#4C# range 0 .. 31;
      PSel at 16#50# range 0 .. 31;
      Srs  at 16#134# range 0 .. 31;
   end record;

   --  General Purpose Input Output
   GioA_Periph : aliased GioA_Peripheral
     with Import, Address => GioA_Base;

end TMS570LC43xx.GioA;
